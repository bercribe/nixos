...
in {
  ...
  home-manager.sharedModules = with inputs.errata.homeModules; [file-actions session-tool];
  ...
  microvm = {
    ...
    volumes = [
      ...
      # writable nix store - disabled because it got corrupted and prevented VM bootup
      # {
